...
- RF-01: Las credenciales deben tener un username y un emisor.
...
- RF-04: Para dar permisos de acceso a una aplicación se debe crear un registro para el usuario con fecha-desde y hasta que dura el permiso. Si no se establece nada la fecha-hasta queda en nulo.
...
- RNF-01: La consulta de dada una credencial, identificar al usuario y verificar si tiene acceso a la aplicacion debe ser < 500 ms.
